 ...
 * FosUserUser
 *
 * @ORM\Table(name="fos_user_user", uniqueConstraints={@ORM\UniqueConstraint(name="uniq_c560d761a0d96fbf", columns={"email_canonical"}), @ORM\UniqueConstraint(name="uniq_c560d76192fc23a8", columns={"username_canonical"})})
 * @ORM\Entity
 */
class FosUserUser
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="Ninfac\ContaBundle\Entity\FosUserGroup", inversedBy="user")
     ...
     * Add group
     *
     * @param \Ninfac\ContaBundle\Entity\FosUserGroup $group
     *
     * @return FosUserUser
     */
    public function addGroup(\Ninfac\ContaBundle\Entity\FosUserGroup $group)
    {
        $this->group[] = $group;
     ...
     * @param \Ninfac\ContaBundle\Entity\FosUserGroup $group
     */
    public function removeGroup(\Ninfac\ContaBundle\Entity\FosUserGroup $group)
    {
