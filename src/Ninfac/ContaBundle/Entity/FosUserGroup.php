...
class FosUserGroup
{
     ...
     * Add user
     *
     * @param \Ninfac\ContaBundle\Entity\FosUserUser $user
     *
     * @return FosUserGroup
     */
    public function addUser(\Ninfac\ContaBundle\Entity\FosUserUser $user)
    {
        $this->user[] = $user;
     ...
     * @param \Ninfac\ContaBundle\Entity\FosUserUser $user
     */
    public function removeUser(\Ninfac\ContaBundle\Entity\FosUserUser $user)
    {
